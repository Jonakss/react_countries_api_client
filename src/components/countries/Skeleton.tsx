...
const SkeletonCard = (props: BoxProps) => {
    return (
        <Box {...props} w={{base: '90vw', md:'350px'}} bgColor={'hsl(209, 23%, 22%)'} borderRadius={15} overflow={'hidden'}>
            <Box >
...
const SkeletonCardList = (props: BoxProps) => {
    return (
        <Flex {...props} direction={{base: "column", sm: 'row'}} wrap={'wrap'} justifyContent={'space-between'} alignItems={'flex-start'} gap={8}>
